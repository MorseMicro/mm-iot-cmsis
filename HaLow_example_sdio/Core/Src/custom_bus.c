...
static void SPI3_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(BUS_SPI3_SCK_GPIO_PORT, GPIO_PIN_10);

    HAL_GPIO_DeInit(BUS_SPI3_MISO_GPIO_PORT, GPIO_PIN_11);

    HAL_GPIO_DeInit(BUS_SPI3_MOSI_GPIO_PORT, GPIO_PIN_12);
