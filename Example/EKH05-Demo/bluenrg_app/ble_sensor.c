...
void Set_DeviceConnectable(void)
{
  ...
  uint8_t device_name_length = sizeof(device_name);

  uint8_t manuf_data[] = {
    2,0x0A,0x00, /* 0 dBm */  // Transmission Power
	device_name_length + 1,0x09,SENSOR_DEMO_NAME,  // Complete Name
  ...
  manuf_data[10 + device_name_length] |= 0x01; /* Sensor Fusion */
